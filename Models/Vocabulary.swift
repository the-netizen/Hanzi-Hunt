...
extension Vocabulary {
    static let samples: [Vocabulary] = [
        Vocabulary(hanzi: "人", pinyin: "rén", english: "person, mankind", object: "person", isCollected: false), //
        Vocabulary(hanzi: "狗", pinyin: "gǒu", english: "dog", object: "dog", isCollected: false), // Collected!
        Vocabulary(hanzi: "猫", pinyin: "māo", english: "cat", object: "cat"),
        Vocabulary(hanzi: "书", pinyin: "shū", english: "book", object: "book", isCollected: false), // Collected!
        ...
        Vocabulary(hanzi: "树", pinyin: "shù", english: "tree", object: "tree", isCollected: false), // Collected!
